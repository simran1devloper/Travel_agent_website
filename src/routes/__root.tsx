...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JourneyMakers — Cinematic, curated travel" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "JourneyMakers — Cinematic, curated travel" },
      { name: "twitter:title", content: "JourneyMakers — Cinematic, curated travel" },
      {
